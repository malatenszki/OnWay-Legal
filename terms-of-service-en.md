...
**Service Provider:** Malatenski David, individual developer (Serbia)
...
- Observing speed limits as posted on traffic signs and road markings
- Choosing a speed appropriate to the traffic situation, road and visibility conditions
- Fully complying with all other traffic rules
...
- The **accuracy** of camera positions displayed in the App
- The **currency or freshness** of camera positions and other POIs
- The **completeness** of data (that all existing cameras are included)
- That each displayed camera is actually operating at any given time
...
- Knowing the traffic rules of the specific country, region, and city
- Observing and following current traffic signs, road markings and authority instructions
- Recognizing and handling traffic situations not signaled by the App

### 3.4 Legal Scope of Liability Disclaimer
...
- Fines, penalties, license suspension, demerit points and other sanctions received by the User due to traffic violations, regardless of whether the App signaled or failed to signal a given camera or POI
...
- Be at least **16 years old** (or, if younger, have the consent of a person with parental responsibility, in line with GDPR Article 8 and applicable national digital-consent age thresholds)
- Hold a valid driver's license, if using the App while operating a motor vehicle
...
- The User must not handle their phone while driving in a manner contrary to local road traffic rules (handheld device use while driving is generally prohibited)
- The App should be configured while the vehicle is **stationary**
- The User must configure the App so that alerts do not distract from driving

### 4.3 Prohibited Conduct

The User must not:
- Use the App for illegal, immoral or rights-infringing purposes
- Submit false or misleading reports
- Set a nickname containing hate speech, slurs, impersonation of officials or offensive content
- Circumvent or disable security measures of the App
- Reverse-engineer, decompile or modify the App
- Transmit spam, viruses or other harmful content through the App
- Use the App for mass scraping of other Users' data
...
- Modify, expand or reduce the App's features at any time
- Temporarily suspend the Service for maintenance, updates or technical reasons
- Terminate the Service at any time for any reason
...
- **For consumer Users in the EU**, the jurisdictional rules of **Articles 17-19 of Regulation (EU) No 1215/2012 (Brussels I bis)** apply. In particular, a consumer may bring proceedings against the Service Provider either in the courts of the Service Provider's domicile or in the courts of the consumer's own domicile.
- **For consumer Users in Serbia**, disputes shall be heard by the court of the consumer's residence in accordance with the Serbian Civil Procedure Act and the Consumer Protection Act.
- **For non-consumer Users**, the parties submit to the exclusive jurisdiction of the courts having jurisdiction over the Service Provider's residence.
